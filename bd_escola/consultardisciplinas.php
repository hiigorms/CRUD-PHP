    ...
    <body>
        ...
        <section>
            <div class="field">
                ...
                <center><font face = "Century Gothic" size =  "6"><b>Consulta de Disciplinas Cadastradas</b><font size = "4">
                ...
                <form name="cliente" method = "POST" action = "">
                    <fieldset id="a">
                        <legend><b> Informe o Nome da Disciplina desejada: </b></legend>
                            <p> Nome: <input name="txtnome" type="text" size="40" placeholder="Nome da Disciplina" required>
                            <br><br><center>
            ...
            if(isset($btnenviar))
            {
                ...
                foreach($pro_bd as $pro_mostrar)
                    {
                        ?> <br>
                        <b> <?php echo "Código de Disciplina: "?> </b><?php echo $pro_mostrar[0]; // como é matriz - posição 0 ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
                        <b> <?php echo "Nome da Disciplina: "?> </b><?php echo $pro_mostrar[1]; // como é matriz - posição 1 ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
                        <?php
                    }
            }
            ?>
