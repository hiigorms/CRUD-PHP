    ...
    <body>
        ...
        <section>
            <div class="field">
                ...
                <center><font face = "Century Gothic" size =  "6"><b>Consulta de Cursos Cadastrados</b><font size = "4">
                ...
                <form name="cliente" method = "POST" action = "">
                    <fieldset id="a">
                        <legend><b> Informe o Nome do Curso desejado: </b></legend>
                            <p> Nome: <input name="txtnome" type="text" size="40" placeholder="Nome do Curso" required>
                            <br><br><center>
            ...
            if(isset($btnenviar))
            {
                ...
                foreach($pro_bd as $pro_mostrar)
                    {
                        ?> <br>
                        <b> <?php echo "Código do Curso: "?> </b><?php echo $pro_mostrar[0]; // como é matriz - posição 0 ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
                        <b> <?php echo "Nome: "?> </b><?php echo $pro_mostrar[1]; // como é matriz - posição 1 ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
                        <b> <?php echo "Código de Disciplina 1: "?> </b><?php echo $pro_mostrar[2]; // como é matriz - posição 2 ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
                        <b> <?php echo "Código de Disciplina 2: "?> </b><?php echo $pro_mostrar[3]; // como é matriz - posição 2 ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
                        <b> <?php echo "Código de Disciplina 3: "?> </b><?php echo $pro_mostrar[4]; // como é matriz - posição 2 ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
                        <?php
                    }
            }
            ?>
