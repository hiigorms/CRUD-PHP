    ...
    <body>
        ...
        <section>
            <div class="field">
                ...
                <center><font face = "Century Gothic" size = "6"> <b>Exclusão de Cursos Cadastrados</b><font size = "4">
                ...
                <form name="cliente" method = "POST" action = "">
                    <fieldset id="a">
                        <legend><b> Informe o código do curso desejado: </b></legend>
                            <p> Código do Curso: <input name="txtcodc" type="number" size="20" maxlength="5" placeholder="Código de Curso" required>
                            <br><br><center>
