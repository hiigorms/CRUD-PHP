    ...
    <body>
        ...
        <section>
            <div class="field">
                ...
                <form name = "cursos" method = "POST" action = "alterarcursos2.php">
                <fieldset>
                    <legend><b> Digite o código do curso desejado: </b></legend>
                        <p> Código: <input name = "txtCodC" type = "text" size = "20" maxlength = "5" palceholder = "Código do curso">
                        <br><br><center>
