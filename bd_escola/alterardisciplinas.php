    ...
    <body>
        ...
        <section>
            <div class="field">
                ...
                <form name = "disciplinas" method = "POST" action = "alterardisciplinas2.php">
                <fieldset>
                    <legend><b> Digite o código da disciplina desejada: </b></legend>
                        <p> Código: <input name = "txtdisc" type = "number" size = "20" maxlength = "5" palceholder = "Código da disciplina" required>
                        <br><br><center>
